...
var pressable_machine_exports = {};
__export(pressable_machine_exports, {
  machine: () => machine
});
module.exports = __toCommonJS(pressable_machine_exports);
    ...
    },
    {
      ...
      actions: {
        trackDocumentPointerEvents(ctx2, _evt, { send }) {
          ...
          const cleanup = [
            (0, import_dom_event.addDomEvent)(doc, "pointermove", onPointerMove, false),
            (0, import_dom_event.addDomEvent)(doc, "pointerup", onPointerUp, false),
            (0, import_dom_event.addDomEvent)(doc, "pointercancel", onPointerCancel, false)
          ];
          if (ctx2.pointerType !== "touch") {
            cleanup.push((0, import_dom_event.addDomEvent)(doc, "contextmenu", onPointerCancel, false));
          }
        ...
        trackDocumentKeyup(ctx2, _evt, { send }) {
          ...
          const cleanup = (0, import_dom_event.addDomEvent)(doc, "keyup", onKeyup, false);
          ctx2.cleanups.push(cleanup);
        },
        ...
        triggerClick(ctx2, { event }) {
          ...
          if (!(0, import_dom_query3.isHTMLElement)(ctx2.target)) {
            return;
          }
        ...
        preventContextMenu(ctx2) {
          ...
          const cleanup = (0, import_dom_event.addDomEvent)(ctx2.target, "contextmenu", onContextMenu, { once: true });
          const onPointerUp = () => void setTimeout(cleanup, 30);
          (0, import_dom_event.addDomEvent)(dom.getWin(ctx2), "pointerup", onPointerUp, { once: true });
        }
      }
    }
  );
