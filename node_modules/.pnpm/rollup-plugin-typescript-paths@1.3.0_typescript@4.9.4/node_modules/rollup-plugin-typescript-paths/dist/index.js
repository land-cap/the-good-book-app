...
var typescriptPaths = function (_a) {
    var _b = _a === void 0 ? {} : _a, _c = _b.tsConfigPath, tsConfigPath = _c === void 0 ? (0, typescript_1.findConfigFile)('./', typescript_1.sys.fileExists) : _c, _d = _b.absolute, absolute = _d === void 0 ? true : _d, transform = _b.transform, _e = _b.preserveExtensions, preserveExtensions = _e === void 0 ? false : _e;
    ...
    return {
        ...
        resolveId: function (importee, importer) {
            ...
            var jsFileName = (0, path_1.join)(outDir, preserveExtensions ? resolvedFileName : resolvedFileName.replace(/\.tsx?$/i, '.js'));
