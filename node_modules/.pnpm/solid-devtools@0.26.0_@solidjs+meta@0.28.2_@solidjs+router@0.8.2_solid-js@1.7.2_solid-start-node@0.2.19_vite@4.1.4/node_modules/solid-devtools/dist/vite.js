...
function getNodeLocationAttribute(node, state, isJSX = false) {
  ...
  return getLocationAttribute(
    path.relative(cwd, state.filename),
    node.loc.start.line,
  ...
  visitor: {
    ...
    ...config.components && {
      FunctionDeclaration(path2, state) {
        ...
        if (!location)
          return;
        path2.node.body.body.unshift(buildMarkComponent({ loc: t2.stringLiteral(location) }));
      },
...
export { devtoolsPlugin as default };
