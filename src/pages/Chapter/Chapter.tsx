...
const VerseNumber = ({ number }: { number: number }) => <sup class={'font-black'}>{number}</sup>
...
export const Chapter = () => {
    ...
    return (
        <div class={'flex flex-col gap-10 py-10'}>
            <h1 class="text-3xl font-black leading-tight tracking-tight text-gray-900">Geneza 1</h1>
