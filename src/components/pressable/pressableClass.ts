export const pressableClass = {
    ...
    variant: {
        ...
        black: 'bg-black text-white hover:bg-gray-800 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-600',
        outline:
            'bg-white text-gray-900 shadow-sm ring-2 ring-inset ring-gray-900 hover:bg-gray-50',
    },
}
