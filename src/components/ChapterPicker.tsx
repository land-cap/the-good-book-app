export const ChapterPicker = ({value}: { value: string }) => (
    <div class={"w-full sm:w-48"}>
        <div class="relative">
            ...
            <ul
                class="hidden absolute z-10 mt-1 max-h-60 w-full overflow-auto bg-white py-1 text-base ring-inset ring-1 ring-black dark:ring-whiteOnDark focus:outline-none sm:text-sm"
                id="options"
                role="listbox"
            >
                <li
