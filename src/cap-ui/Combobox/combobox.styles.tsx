...
export const comboboxStyles = {
    ...
    option: twMerge('relative cursor-pointer select-none py-2 pl-3 pr-9 text-gray-900', transitionQuick),
    option_focused: 'bg-primary-600 text-white',
    option_checked: 'font-semibold',
    optionLabel: 'block truncate',
    optionIcon: twMerge('absolute inset-y-0 right-0 flex items-center pr-4 text-primary-600', transitionQuick),
